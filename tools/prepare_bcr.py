...
def prepare(archive, output, url=None):
    ...
    with tarfile.open(archive, 'r:gz') as tar:
        ...
        if prefix != 'best-cpp-' + version:
            raise ValueError('archive prefix must match the module version')
        for required in ['BUILD.bazel', 'LICENSE', 'best/best.hpp']:
    ...
    source = {
        'url': url or f'https://github.com/jhurliman/best-cpp/archive/refs/tags/v{version}.tar.gz',
